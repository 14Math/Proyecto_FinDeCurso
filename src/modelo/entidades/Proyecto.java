...
public class Proyecto implements Serializable {
	...
	public double margenPrevisto() {
		return ventaPrevisto.doubleValue() - costesPrevisto.doubleValue(); // "Importe de venta – coste previsto"  
	}
	public double margenReal() {
		return ventaPrevisto.doubleValue() - costeReal.doubleValue(); // Importe de venta – gastos reales
	}
	public double diferenciaGastos() {
		return costeReal.doubleValue() - costesPrevisto.doubleValue(); //Gasto real – gasto previsto
	}
	
	public int diferenciaFinPrevistoReal(){
		return 1; //Días entre fin previsto y fin real
	}
