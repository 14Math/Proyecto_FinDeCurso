...
public class TestProyecto{
	...
	public static void main(String[] args) {
		...
		System.out.println("\n");
        Proyecto proyecto = new Proyecto("FOR2000", BigDecimal.valueOf(10000), BigDecimal.valueOf(15000), 
        								"Formacion de habilidades directivas", "ACTIVO", Date.valueOf("2000-01-01"), 
        								...
        								new Empleado(45, "Patricio", "estrella@ifp.es", Date.valueOf("2020-12-15"), Date.valueOf("1992-01-20"), 
